...
import keras # this is the deep learning library we are using
import tensorflow as tf # this is the deep learning library we are using
from keras.preprocessing.text import Tokenizer # this module is used to tokenize the text data into a format that can be used by the neural network
...
from keras.models import Sequential # this is the type of neural network we will be using
from keras.layers import Embedding, Flatten, Dense # these are the layers we will be using in our neural network
